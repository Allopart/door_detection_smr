...
*/
  ...
  pcl_pub = nh.advertise<sensor_msgs::PointCloud2> ("/cropped/pointcloud", 1);
  img_pub = nh.advertise<sensor_msgs::Image> ("/cropped/image_rect", 1);
  depth_pub = nh.advertise<sensor_msgs::Image> ("/cropped/depth_rect", 1);
